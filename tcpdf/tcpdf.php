...
function racecertificat($raceequin) 
{
if ($raceequin=='4')
{
$this->SetFillColor(152 ,251 ,152);
$this->RoundedRect(5, 1, 200, 5, 1.50, '1111', 'DF');$this->RoundedRect(5, 140.5, 200, 5, 1.50, '1111', 'DF');
// $this->Cell(200,1,'Arabe-Barbe',1,1,'C',1,0,'');
...
function racelivret($raceequin) 
{
$x=5; $y=1; $y1=140.5; $w=200; $h=5;
if ($raceequin=='4')
{
$this->SetFillColor(152 ,251 ,152);$this->RoundedRect($x, $y, $w, 5, 1.50, '1111', 'DF');$this->RoundedRect($x, $y1, $w, $h, 1.50, '1111', 'DF');$this->SetFillColor(0, 0, 0);
}
if ($raceequin=='6')
{
$this->SetFillColor(135 ,206 ,235);$this->RoundedRect($x, $y, $w, 5, 1.50, '1111', 'DF');$this->RoundedRect($x, $y1, $w, $h, 1.50, '1111', 'DF');$this->SetFillColor(0, 0, 0);
}
if ($raceequin=='2')
{
$this->SetFillColor(255, 228, 225);$this->RoundedRect($x, $y, $w, 5, 1.50, '1111', 'DF');$this->RoundedRect($x, $y1, $w, $h, 1.50, '1111', 'DF');$this->SetFillColor(0, 0, 0);
}

if ($raceequin=='3')
{
$this->SetFillColor(255, 255, 255);$this->RoundedRect($x, $y, $w, 5, 1.50, '1111', 'DF');$this->RoundedRect($x, $y1, $w, $h, 1.50, '1111', 'DF');$this->SetFillColor(0, 0, 0);
}
}
	...
	//******//
function raceequin($raceequin) //beige  pour baudet
{
if ($raceequin=='4')
{
$this->SetFillColor(152 ,251 ,152);//verte arabe-barbe verte selon decrete 1995
$this->RoundedRect(5, 1, 95, 10, 1.50, '1111', 'DF');
$this->RoundedRect(101, 1, 192, 52, 1.50, '1111', 'DF');
$this->SetFillColor(255, 255, 255);
$this->StartTransform();
$this->Rotate(35.3, 42, 260);
$this->SetFillColor(255, 255, 255);
$this->SetTextColor(225,0,0);
$this->SetXY(1,180);$this->SetFont('aefurat', '', 22);
$this->Cell(200,1,'Arabe-Barbe',0,1,'C',0,0,'');$this->SetXY(200,180);$this->Cell(200,1,'Arabe-Barbe',0,1,'L',0,0,'');
$this->SetFont('aefurat', '', 12);
$this->SetFillColor(127, 221, 76);
$this->SetTextColor(0,0,0);
$this->SetXY(1,190);
$this->Cell(400,0,'',0,1,'C',1,0,'');
$this->SetFillColor(225, 0,0);
$this->SetXY(1,198);
$this->Cell(400,0,'',0,1,'C',1);
$this->StopTransform();
}
if ($raceequin=='6')
{
$this->SetFillColor(135 ,206 ,235);//bleu barbe  bleu selon decrete 1995
$this->RoundedRect(5, 1, 95, 10, 1.50, '1111', 'DF');
$this->RoundedRect(101, 1, 192, 52, 1.50, '1111', 'DF');
$this->SetFillColor(255, 255, 255);
$this->StartTransform();
...
$this->SetTextColor(225,0,0);
$this->SetXY(1,180);$this->SetFont('aefurat', '', 22);
$this->Cell(200,1,'Barbe',0,1,'C',0,0,'');$this->SetXY(200,180);$this->Cell(200,1,'Barbe',0,1,'L',0,0,'');
$this->SetFont('aefurat', '', 12);
$this->SetFillColor(127, 221, 76);
$this->SetTextColor(0,0,0);
$this->SetXY(1,190);
...
$this->SetFillColor(255, 228, 225);//rose ps arab  rouge selon decrete 1995
$this->RoundedRect(5, 1, 95, 10, 1.50, '1111', 'DF');
$this->RoundedRect(101, 1, 192, 52, 1.50, '1111', 'DF');
$this->SetFillColor(255, 255, 255);
$this->StartTransform();
...
$this->SetTextColor(225,0,0);
$this->SetXY(1,180);$this->SetFont('aefurat', '', 22);
$this->Cell(200,1,'Pur-Sang-Arabe',0,1,'C',0,0,'');$this->SetXY(200,180);$this->Cell(200,1,'Pur-Sang-Arabe',0,1,'L',0,0,'');
$this->SetFont('aefurat', '', 12);
$this->SetFillColor(127, 221, 76);
$this->SetTextColor(0,0,0);
$this->SetXY(1,190);
...
if ($raceequin=='3')
{
$this->SetFillColor(255, 255, 255);//blanC ps anglai blanc  selon decrete 1995
$this->RoundedRect(5, 1, 95, 10, 1.50, '1111', 'DF');
$this->RoundedRect(101, 1, 192, 52, 1.50, '1111', 'DF');
$this->SetFillColor(255, 255, 255);
$this->StartTransform();
...
$this->SetTextColor(225,0,0);
$this->SetXY(1,180);$this->SetFont('aefurat', '', 22);
$this->Cell(200,1,'Pur-Sang-Anglais',0,1,'C',0,0,'');$this->SetXY(200,180);$this->Cell(200,1,'Pur-Sang-Anglais',0,1,'L',0,0,'');
$this->SetFont('aefurat', '', 12);
$this->SetFillColor(127, 221, 76);
$this->SetTextColor(0,0,0);
$this->SetXY(1,190);
...
function raceequin1($raceequin) 
{
if ($raceequin=='4')
{
$this->SetFillColor(152 ,251 ,152);//vert arabe-barbe
$this->RoundedRect(10, 70, 272, 40, 1.50, '1111', 'DF');
$this->SetFillColor(255, 255, 255);
$this->StartTransform();
$this->Rotate(35.3, 42, 260);
$this->SetFillColor(255, 255, 255);
...
if ($raceequin=='6')
{
$this->SetFillColor(135 ,206 ,235);//bleu barbe
$this->RoundedRect(10, 70, 272, 40, 1.50, '1111', 'DF');
$this->SetFillColor(255, 255, 255);
$this->StartTransform();
$this->Rotate(35.3, 42, 260);
...
$this->SetFillColor(255, 228, 225);//rose ps arab
$this->RoundedRect(10, 70, 272, 40, 1.50, '1111', 'DF');
$this->SetFillColor(255, 255, 255);
$this->StartTransform();
$this->Rotate(35.3, 42, 260);
...
if ($raceequin=='3')
{
$this->SetFillColor(255, 255, 255);//blan ps anglai
$this->RoundedRect(10, 70, 272, 40, 1.50, '1111', 'DF');
$this->SetFillColor(255, 255, 255);
$this->StartTransform();
$this->Rotate(35.3, 42, 260);
...
$this->StopTransform();
 ...
 function nbrtostringv($tb_name,$colonename,$colonevalue,$resultatstring) 
	...
	function nbrtostring0($tb_name,$colonename,$colonevalue,$resultatstring) 
	{
...
//ne pas modifier
	...
	function Barcode($x, $y, $barcode, $h, $w, $len)
	{
		...
		$this->SetFont('dejavusans','', 12);$this->SetFont('dejavusans','',12);
		//$this->Text($x,$y+$h+0.5/$this->k,substr($barcode,-$len));
		$this->Text($x-2,$y+$h+0.5/$this->k,substr($barcode,-$len));
	}
// ***************************************************barre code******************************************

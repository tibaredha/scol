...
class HTML  {
	...
	function photosdb($station) 
	{
	    ...
	    echo "<marquee behavior=\"scroll\" direction=\"UP\" scrollamount=\"3\" scrolldelay=\"80\" onmouseover=\"this.stop()\"onmouseout=\"this.start()\" height=\"440\" width=\"400\" bgcolor=\"GREEN\">";
	    
		echo "<H2 align=\"center\">Bienvenue sur SIRE ONDEEC 1.0 </H2>";
		echo "<p align=\"center\"><img  id=\"mydiv1\"   align=\"center\"  src=\"".URL.'public/images/cheval/logoof.png'."\" width=\"400\" height=\"340\" alt=\"1\" /></p>";
		echo "<H4 id=\"mydiv3\" >Directeur ONDEEC </H4>"; 
		echo "<p align=\"center\"><img  id=\"mydiv1\"   align=\"center\"  src=\"".URL.'public/images/BOSS1.jpg'."\" width=\"400\" height=\"340\" alt=\"1\" /></p>";
		
		while($data =  mysql_fetch_array($result))
		{
		   echo "<H4 id=\"mydiv3\" >".$data[7]." : ".$this->nbrtostringv('race','id',$data["Race"],'race').' : '.$data[2]."</H4>"; 
		   $fichier1 = "d:/cheval/public/images/cheval/".$data[0].'.jpg' ;
		   ...
		   {
		   echo "<p align=\"center\"><img  id=\"mydiv2\"   align=\"center\"  src=\"".URL.'public/images/cheval/cr.jpg'."\" width=\"400\" height=\"340\" alt=\"cheval\" /></p>";
		   }
		}
		echo "</marquee>";
		echo "</div>";	
	...
	{
	   case '1' :
			{ return   $bgcolor_ABO= 'bgcolor="BLACK"     style="color:WHITE"  ';break;}
	   case '2' :
			{ return   $bgcolor_ABO= 'bgcolor="RED"     style="color:WHITE"  ';break;}
	   case '3' :
			{ return   $bgcolor_ABO= 'bgcolor="WHITE"     style="color:BLACK"  ';break;}
	   case '4' :
			{ return   $bgcolor_ABO= 'bgcolor="GREEN"     style="color:WHITE"  ';break;}	
	   case '5' :
			{ return   $bgcolor_ABO= 'bgcolor=""     style="color:BLACK"  ';break;}
	   case '6' :
			{ return   $bgcolor_ABO= 'bgcolor="BLUE"     style="color:WHITE"  ';break;}			
	}		
	}
	
	function bgcolor_SEX($ABO) 
	{
	switch($ABO)  
	{
	   case 'M' :
	...
	function menuview0($id,$SERVER_NAME)
    {
	echo '<button id="Cleara"  onclick="javascript:window.location.reload() ;return false;">Clear Area</button> ';
	echo '<input  id="Clearb" type="submit" />';
	echo '<button id="Clearl"  onclick="javascript:list('."'".$SERVER_NAME."'".') ;return false;">Lister</button> ';
	}
	function menuview($id,$SERVER_NAME)
    {
	echo '<button id="Cleard"  onclick="javascript:Vacciner('.$id.','."'".$SERVER_NAME."'".') ;return false;">Vacciner</button> ';
	echo '<button id="Cleare"  onclick="javascript:Bilanter('.$id.','."'".$SERVER_NAME."'".') ;return false;">Bilanter</button> ';
	echo '<button id="Clearf"  onclick="javascript:Traiter('.$id.','."'".$SERVER_NAME."'".') ;return false;">Traiter</button> ';
	echo '<button id="Clearg"  onclick="javascript:Saillir('.$id.','."'".$SERVER_NAME."'".') ;return false;">Saillir</button> ';
	echo '<button id="Clearh"  onclick="javascript:list('."'".$SERVER_NAME."'".') ;return false;">Lister</button> ';
	}
	function menuview1($id,$SERVER_NAME)
    {
	echo '<button id="Cleari"  onclick="javascript:window.location.reload() ;return false;">Clear Area</button> ';
	echo '<input  id="Clearj" type="submit" />';
	echo '<button id="Cleark"  onclick="javascript:view('.$id.','."'".$SERVER_NAME."'".') ;return false;">view</button> ';
	echo '<button id="Clearl"  onclick="javascript:list('."'".$SERVER_NAME."'".') ;return false;">Lister</button> ';
	}
	function menuview2($id,$SERVER_NAME)
    {
	echo '<button id="Cleari"  onclick="javascript:window.location.reload() ;return false;">Clear Area</button> ';
    ...
    {
	echo '<fieldset id="fieldset5">';
	echo '<legend>Signalement Graphique</legend>';
	HTML::Image(URL."public/images/ch1.jpg", $width = 260, $height = 240, $border = -1, $title = -1, $map = -1, $name = -1, $class = 'image',$id='image');
	echo '</fieldset>';
	HTML::Br(16);
	
	echo '<fieldset id="fieldset1">';
	echo '<legend>Mois</legend>';
	echo "<button id=\"btgraphe\"  onclick=\"document.location='".URL."dashboard/".$ctrl."/0';  \"   title=\"Par mois\">Signalement</button> " ;		
	echo "<button id=\"btgraphe\"  onclick=\"document.location='".URL."dashboard/".$ctrl."/4';  \"   title=\"Par mois\">Saillis</button> " ;
	echo "<button id=\"btgraphe\"  onclick=\"document.location='".URL."dashboard/".$ctrl."/5';  \"   title=\"Par mois\">Produits</button> " ;
	echo '</fieldset>';
	echo '<fieldset id="fieldset11">';
	echo '<legend>Annee</legend>';
	echo "<button id=\"btgraphe\"  onclick=\"document.location='".URL."dashboard/".$ctrl."/1';  \"   title=\"Par Année\">Signalement</button> " ;				
	echo "<button id=\"btgraphe\"  onclick=\"document.location='".URL."dashboard/".$ctrl."/3';  \"   title=\"Par Année\">Saillis</button> " ;
	echo "<button id=\"btgraphe\"  onclick=\"document.location='".URL."dashboard/".$ctrl."/6';  \"   title=\"Par Année\">Produits</button> " ;
	
	echo '</fieldset>';
	echo '<fieldset id="fieldset11">';
	echo '<legend>Station : '.$id.'</legend>';	
	echo "<button id=\"btgraphe\"  onclick=\"document.location='".URL."dashboard/".$ctrl."/2';  \"   title=\"Par Race\">Race</button> " ;		
	echo "<button id=\"btgraphe\"  onclick=\"document.location='".URL."dashboard/".$ctrl."/7';  \"   title=\"Par Race\">Sexe</button> " ;	
	echo "<button id=\"btgraphe\"  onclick=\"document.location='".URL."dashboard/SIGA';  \"          title=\"Par Race\">Sig</button> " ;	
	echo '</fieldset>';
	HTML::Br(3);
	}
	...
	$fichier ='D:\cheval\libs\cheval.php';	
	...
	echo date('H:i:s') , " Set document properties" , EOL;
		...
		$objPHPExcel->setActiveSheetIndex(0)
					->setCellValue('A1', 'N')
					->setCellValue('B1', 'id')
					->setCellValue('C1', 'NomP')
					->setCellValue('D1', 'NomA')
					->setCellValue('E1', 'Pere')
					->setCellValue('F1', 'mere')
					->setCellValue('G1', 'Sexe')
					->setCellValue('H1', 'Dns')
					->setCellValue('I1', 'Race')
					->setCellValue('J1', 'Robe')
					->setCellValue('K1', 'Num')
					->setCellValue('L1', 'Datesigna')
					
					;
		
		// Rename worksheet
	    echo date('H:i:s') , " call database" , EOL;
		$sqlPes = "SELECT * FROM cheval where station =$STRUCTURED  order by Datesigna";  
		...
		for ($i = 2; $i <= $numPes + 1; $i++) {
			...
			$objPHPExcel->setActiveSheetIndex(0)
				 ...
				 ->setCellValue('B'.$i, $resPes['id'])
				 ->setCellValue('C'.$i, $resPes['NomP'])
				 ->setCellValue('D'.$i, $resPes['NomA'])
				 ->setCellValue('E'.$i, $resPes['Pere'])
				 ->setCellValue('F'.$i, $resPes['mere'])
				 ->setCellValue('G'.$i, $resPes['Sexe'])
				 ->setCellValue('H'.$i, $resPes['Dns'])
				 ->setCellValue('I'.$i, $resPes['Race'])
				 ->setCellValue('J'.$i, $resPes['Nobo'])
				 ->setCellValue('K'.$i, $resPes['N'])
				 ->setCellValue('L'.$i, $resPes['Datesigna'])
	...
	$objPHPExcel->getActiveSheet()->setTitle('CHEVAL');
    $objPHPExcel->setActiveSheetIndex(0);
	...
	$objPHPExcel->getActiveSheet()->getStyle('A1:L1')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setARGB('FF69B4');
	...
	echo '<a href="'.URL.'libs/CHEVAL.xls">Enregistrer Sous xls</a></br>';
	echo '<a href="'.URL.'libs/CHEVAL.xlsx">Enregistrer Sous xlsx</a></br>';
    ...
    {
        // structure ou la totalit顤e la BDD
        if($mode == 1 || $mode == 2)
        {
            $creations .= "-- -----------------------------\n";
	...
	$time=date('d-m-Y'); 
	$fichierDump = fopen("D:/cheval".$time.".sql", "wb");
   // $fichierDump = fopen(dump_mysql.$time.".sql", "wb");
    ...
    echo "Sauvegarde terminée au niveau D:/cheval".$time.".sql";
			...
			echo "<form   onsubmit=\"return validateForm11(this);\" name=\"form1\"  action=\"".URL.$data['c']."/".$data['m']."/0/10\" method=\"GET\">" ;
				// echo "<tr bgcolor='#EDF7FF' >" ;
					// echo "<td align=\"left\"  >" ;
						...
						echo "</select>&nbsp;" ;
						echo "<input id=\"search0\"  type=\"search\"  placeholder=\"Search...\"    name=\"q\"  value=\"\"  autofocus /> " ;//<!-- onfocus = "tooltip.pop(this,'Donors: <br />Search Keyword.');"   -->
						// echo "<img id=\"search1\" src=\"".URL."public/images/search.PNG\" width='20' height='20' border='0' alt=''/>" ;
   ...
   //**********************************//
	...
	$sql = " select * from $TBL  where $COLONE1 BETWEEN '$DATEJOUR1' AND '$DATEJOUR2' and (station $STR )";
	...
	echo "</div>";
     ...
     //**********************************//
	function svaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$DATEJOUR1,$DATEJOUR2,$VALEUR2,$STR) 
	{
	$cnx = mysql_connect($this->db_host,$this->db_user,$this->db_pass)or die ('I cannot connect to the database because: ' . mysql_error());
	$db  = mysql_select_db($this->db_name,$cnx) ;
	$sql = " select * from $TBL  where $COLONE1 BETWEEN '$DATEJOUR1' AND '$DATEJOUR2' and (station $STR )";
    ...
    function sgraphemois($x,$y,$TITRE,$SRS,$TBL,$COLONE1,$COLONE2,$ANNEE,$IND,$STR) 
	{
	include "./chart/libchart/classes/libchart.php";
	$chart = new VerticalBarChart();
	$fichier='./chart/demo/generated/demo1.png';
	$dataSet = new XYDataSet();
	$dataSet->addPoint(new Point("JAN", $this->svaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-01-01",$ANNEE."-01-31",$IND,$STR) ));
	$dataSet->addPoint(new Point("FEV", $this->svaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-02-01",$ANNEE."-02-29",$IND,$STR)));
	$dataSet->addPoint(new Point("MAR", $this->svaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-03-01",$ANNEE."-03-31",$IND,$STR)));
	$dataSet->addPoint(new Point("AVR", $this->svaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-04-01",$ANNEE."-04-30",$IND,$STR)));
	$dataSet->addPoint(new Point("MAI", $this->svaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-05-01",$ANNEE."-05-31",$IND,$STR)));
	$dataSet->addPoint(new Point("JUIN",$this->svaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-06-01",$ANNEE."-06-30",$IND,$STR)));
	$dataSet->addPoint(new Point("JUIL",$this->svaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-07-01",$ANNEE."-07-31",$IND,$STR)));
	$dataSet->addPoint(new Point("AOUT",$this->svaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-08-01",$ANNEE."-08-31",$IND,$STR)));
	$dataSet->addPoint(new Point("SEP", $this->svaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-09-01",$ANNEE."-09-30",$IND,$STR)));
	$dataSet->addPoint(new Point("OCT", $this->svaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-10-01",$ANNEE."-10-31",$IND,$STR)));
	$dataSet->addPoint(new Point("NOV", $this->svaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-11-01",$ANNEE."-11-30",$IND,$STR)));
	$dataSet->addPoint(new Point("DEC", $this->svaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-12-01",$ANNEE."-12-31",$IND,$STR)));
	$chart->setDataSet($dataSet);
	$DATE=date("d-m-Y");
	$chart->setTitle($TITRE.$DATE);
	$chart->render($fichier);	
	...
	//**********************************//
	function pvaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$DATEJOUR1,$DATEJOUR2,$VALEUR2,$STR) 
	{
	$cnx = mysql_connect($this->db_host,$this->db_user,$this->db_pass)or die ('I cannot connect to the database because: ' . mysql_error());
	$db  = mysql_select_db($this->db_name,$cnx) ;
	$sql = " select * from $TBL  where $COLONE1 BETWEEN '$DATEJOUR1' AND '$DATEJOUR2' and (station $STR )";
    ...
    function pgraphemois($x,$y,$TITRE,$SRS,$TBL,$COLONE1,$COLONE2,$ANNEE,$IND,$STR) 
	{
	include "./chart/libchart/classes/libchart.php";
	$chart = new VerticalBarChart();
	$fichier='./chart/demo/generated/demo1.png';
	$dataSet = new XYDataSet();
	$dataSet->addPoint(new Point("JAN", $this->pvaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-01-01",$ANNEE."-01-31",$IND,$STR) ));
	$dataSet->addPoint(new Point("FEV", $this->pvaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-02-01",$ANNEE."-02-29",$IND,$STR)));
	$dataSet->addPoint(new Point("MAR", $this->pvaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-03-01",$ANNEE."-03-31",$IND,$STR)));
	$dataSet->addPoint(new Point("AVR", $this->pvaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-04-01",$ANNEE."-04-30",$IND,$STR)));
	$dataSet->addPoint(new Point("MAI", $this->pvaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-05-01",$ANNEE."-05-31",$IND,$STR)));
	$dataSet->addPoint(new Point("JUIN",$this->pvaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-06-01",$ANNEE."-06-30",$IND,$STR)));
	$dataSet->addPoint(new Point("JUIL",$this->pvaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-07-01",$ANNEE."-07-31",$IND,$STR)));
	$dataSet->addPoint(new Point("AOUT",$this->pvaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-08-01",$ANNEE."-08-31",$IND,$STR)));
	$dataSet->addPoint(new Point("SEP", $this->pvaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-09-01",$ANNEE."-09-30",$IND,$STR)));
	$dataSet->addPoint(new Point("OCT", $this->pvaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-10-01",$ANNEE."-10-31",$IND,$STR)));
	$dataSet->addPoint(new Point("NOV", $this->pvaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-11-01",$ANNEE."-11-30",$IND,$STR)));
	$dataSet->addPoint(new Point("DEC", $this->pvaleurmois($SRS,$TBL,$COLONE1,$COLONE2,$ANNEE."-12-01",$ANNEE."-12-31",$IND,$STR)));
	$chart->setDataSet($dataSet);
	$DATE=date("d-m-Y");
	$chart->setTitle($TITRE.$DATE);
	$chart->render($fichier);	
	...
	function valeurmultigraphe($TBL,$COLONE1,$DATEJOUR1,$DATEJOUR2,$COLONE2,$VALEUR2,$COLONE3,$VALEUR3) 
	{
	$cnx = mysql_connect($this->db_host,$this->db_user,$this->db_pass)or die ('I cannot connect to the database because: ' . mysql_error());
	$db  = mysql_select_db($this->db_name,$cnx) ;
	...
	function multigraphe($x,$y,$TITRE,$TBL,$COL,$COLONE,$VALEUR1,$VALEUR2,$COLONE3,$VALEUR3) //,$data$data[$DATE-4]
	{
	include "./CHART/libchart/classes/libchart.php";
	$chart = new VerticalBarChart();
	...
	$serie1->addPoint(new Point($DATE-9,$this->valeurmultigraphe($TBL,$COL,($DATE-9)."-01-01",($DATE-9)."-12-31",$COLONE,$VALEUR1,$COLONE3,$VALEUR3)));
	$serie1->addPoint(new Point($DATE-8,$this->valeurmultigraphe($TBL,$COL,($DATE-8)."-01-01",($DATE-8)."-12-31",$COLONE,$VALEUR1,$COLONE3,$VALEUR3)));
	$serie1->addPoint(new Point($DATE-7,$this->valeurmultigraphe($TBL,$COL,($DATE-7)."-01-01",($DATE-7)."-12-31",$COLONE,$VALEUR1,$COLONE3,$VALEUR3)));
	$serie1->addPoint(new Point($DATE-6,$this->valeurmultigraphe($TBL,$COL,($DATE-6)."-01-01",($DATE-6)."-12-31",$COLONE,$VALEUR1,$COLONE3,$VALEUR3)));
	$serie1->addPoint(new Point($DATE-5,$this->valeurmultigraphe($TBL,$COL,($DATE-5)."-01-01",($DATE-5)."-12-31",$COLONE,$VALEUR1,$COLONE3,$VALEUR3)));
	$serie1->addPoint(new Point($DATE-4,$this->valeurmultigraphe($TBL,$COL,($DATE-4)."-01-01",($DATE-4)."-12-31",$COLONE,$VALEUR1,$COLONE3,$VALEUR3)));
	$serie1->addPoint(new Point($DATE-3,$this->valeurmultigraphe($TBL,$COL,($DATE-3)."-01-01",($DATE-3)."-12-31",$COLONE,$VALEUR1,$COLONE3,$VALEUR3)));
	$serie1->addPoint(new Point($DATE-2,$this->valeurmultigraphe($TBL,$COL,($DATE-2)."-01-01",($DATE-2)."-12-31",$COLONE,$VALEUR1,$COLONE3,$VALEUR3)));
	$serie1->addPoint(new Point($DATE-1,$this->valeurmultigraphe($TBL,$COL,($DATE-1)."-01-01",($DATE-1)."-12-31",$COLONE,$VALEUR1,$COLONE3,$VALEUR3)));
	$serie1->addPoint(new Point($DATE-0,$this->valeurmultigraphe($TBL,$COL,($DATE-0)."-01-01",($DATE-0)."-12-31",$COLONE,$VALEUR1,$COLONE3,$VALEUR3)));
	$dataSet->addSerie($VALEUR1, $serie1);
	
	$serie2 = new XYDataSet();
	$serie2->addPoint(new Point($DATE-9, $this->valeurmultigraphe($TBL,$COL,($DATE-9)."-01-01",($DATE-9)."-12-31",$COLONE,$VALEUR2,$COLONE3,$VALEUR3)));
	$serie2->addPoint(new Point($DATE-8, $this->valeurmultigraphe($TBL,$COL,($DATE-8)."-01-01",($DATE-8)."-12-31",$COLONE,$VALEUR2,$COLONE3,$VALEUR3)));
	$serie2->addPoint(new Point($DATE-7, $this->valeurmultigraphe($TBL,$COL,($DATE-7)."-01-01",($DATE-7)."-12-31",$COLONE,$VALEUR2,$COLONE3,$VALEUR3)));
	$serie2->addPoint(new Point($DATE-6, $this->valeurmultigraphe($TBL,$COL,($DATE-6)."-01-01",($DATE-6)."-12-31",$COLONE,$VALEUR2,$COLONE3,$VALEUR3)));
	$serie2->addPoint(new Point($DATE-5, $this->valeurmultigraphe($TBL,$COL,($DATE-5)."-01-01",($DATE-5)."-12-31",$COLONE,$VALEUR2,$COLONE3,$VALEUR3)));
	$serie2->addPoint(new Point($DATE-4, $this->valeurmultigraphe($TBL,$COL,($DATE-4)."-01-01",($DATE-4)."-12-31",$COLONE,$VALEUR2,$COLONE3,$VALEUR3)));
	$serie2->addPoint(new Point($DATE-3, $this->valeurmultigraphe($TBL,$COL,($DATE-3)."-01-01",($DATE-3)."-12-31",$COLONE,$VALEUR2,$COLONE3,$VALEUR3)));
	$serie2->addPoint(new Point($DATE-2, $this->valeurmultigraphe($TBL,$COL,($DATE-2)."-01-01",($DATE-2)."-12-31",$COLONE,$VALEUR2,$COLONE3,$VALEUR3)));
	$serie2->addPoint(new Point($DATE-1, $this->valeurmultigraphe($TBL,$COL,($DATE-1)."-01-01",($DATE-1)."-12-31",$COLONE,$VALEUR2,$COLONE3,$VALEUR3)));
	$serie2->addPoint(new Point($DATE-0, $this->valeurmultigraphe($TBL,$COL,($DATE-0)."-01-01",($DATE-0)."-12-31",$COLONE,$VALEUR2,$COLONE3,$VALEUR3)));
	...
	function valeurmultigraphe1($c,$v,$COLONE3,$VALEUR3) 
	{
	$cnx = mysql_connect($this->db_host,$this->db_user,$this->db_pass)or die ('I cannot connect to the database because: ' . mysql_error());
	$db  = mysql_select_db($this->db_name,$cnx) ;
	$sql = " select * from cheval where  ($c='$v') and  $COLONE3 $VALEUR3  ";
	$requete = @mysql_query($sql) or die($sql."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
	}
	function multigraphe1($x,$y,$TITRE,$TBL,$COL,$COLONE,$VALEUR1,$VALEUR2,$COLONE3,$VALEUR3) //,$data$data[$DATE-4]
	{
	include "./CHART/libchart/classes/libchart.php";
	...
	$dataSet = new XYDataSet();
	$dataSet->addPoint(new Point("Pur-Sang-Arabe", $this->valeurmultigraphe1('Race','2',$COLONE3,$VALEUR3) ));
	$dataSet->addPoint(new Point("Pur-Sang-Anglais", $this->valeurmultigraphe1('Race','3',$COLONE3,$VALEUR3)));
	$dataSet->addPoint(new Point("Arabe-Barbe", $this->valeurmultigraphe1('Race','4',$COLONE3,$VALEUR3)));
	$dataSet->addPoint(new Point("Barbe",$this->valeurmultigraphe1('Race','6',$COLONE3,$VALEUR3)));
	$chart->setDataSet($dataSet);
	$chart->setTitle($TITRE.date("d-m-Y"));
	$chart->render($fichier);	
	echo "<div class=\"data\" style=\" position:absolute;left:".$x."px;top:".$y."px;\">";	
	...
	function valeurmultigraphe11($c,$v,$COLONE3,$VALEUR3) 
	{
	$cnx = mysql_connect($this->db_host,$this->db_user,$this->db_pass)or die ('I cannot connect to the database because: ' . mysql_error());
	$db  = mysql_select_db($this->db_name,$cnx) ;
	$sql = " select * from cheval where  ($c='$v') and  $COLONE3 $VALEUR3  ";
	...
	function multigraphe11($x,$y,$TITRE,$TBL,$COL,$COLONE,$VALEUR1,$VALEUR2,$COLONE3,$VALEUR3) //,$data$data[$DATE-4]
	{
	include "./CHART/libchart/classes/libchart.php";
	$fichier='./CHART/demo/generated/pie_chart_color.png';
	$DATE=date("Y");
	...
	$dataSet = new XYDataSet();
	$dataSet->addPoint(new Point("M", $this->valeurmultigraphe11('Sexe','M',$COLONE3,$VALEUR3) ));
	$dataSet->addPoint(new Point("F", $this->valeurmultigraphe11('Sexe','F',$COLONE3,$VALEUR3)));
	$chart->setDataSet($dataSet);
	$chart->setTitle($TITRE.date("d-m-Y"));
	$chart->render($fichier);	
	echo "<div class=\"data\" style=\" position:absolute;left:".$x."px;top:".$y."px;\">";	
	...
	public function WILAYAx($id,$name,$class,$value,$selected) 
	{
	$cnx = mysql_connect($this->db_host,$this->db_user,$this->db_pass)or die ('I cannot connect to the database because: ' . mysql_error());
	$db  = mysql_select_db($this->db_name,$cnx) ;		 
	echo "<select size=1 id=\"".$id."\" class=\"".$class."\" name=\"".$name."\">"."\n";
	echo"<option value=\"".$value."\"  selected=\"selected\">".$selected."</option>"."\n";
	mysql_query("SET NAMES 'UTF8' ");
	$result = mysql_query("SELECT * FROM wil order by WILAYAS" );
	while($data =  mysql_fetch_array($result))
	...
	function COMMUNEx($id,$name,$class,$value,$selected) 
	{	 
	echo "<select size=1 id=\"".$id."\"  class=\"".$class."\" name=\"".$name."\">"."\n";
	echo"<option value=\"".$value."\" selected=\"selected\">".$selected."</option>"."\n";
	echo '</select>'."\n";
	...
	function RACE1($id,$name,$class,$value,$selected) 
	{
	$cnx = mysql_connect($this->db_host,$this->db_user,$this->db_pass)or die ('I cannot connect to the database because: ' . mysql_error());
	$db  = mysql_select_db($this->db_name,$cnx) ;
	echo "<select id=\"".$id."\"   size=1 id=\"wil\" class=\"".$class."\" name=\"".$name."\">"."\n";
	echo"<option value=\"".$value."\"  selected=\"selected\">".$selected."</option>"."\n";
	mysql_query("SET NAMES 'UTF8' ");
	$result = mysql_query("SELECT * FROM race where id != 1  order by race" );
	while($data =  mysql_fetch_array($result))
	...
	function ROBE1($id,$name,$class,$value,$selected) 
	{
	$cnx = mysql_connect($this->db_host,$this->db_user,$this->db_pass)or die ('I cannot connect to the database because: ' . mysql_error());
	$db  = mysql_select_db($this->db_name,$cnx) ;
	echo "<select id=\"".$id."\"   size=1 id=\"wil\" class=\"".$class."\" name=\"".$name."\">"."\n";
	...
	function PAYS($id,$name,$class,$value,$selected) 
	{
	$cnx = mysql_connect($this->db_host,$this->db_user,$this->db_pass)or die ('I cannot connect to the database because: ' . mysql_error());
	$db  = mysql_select_db($this->db_name,$cnx) ;
	echo "<select id=\"".$id."\"   size=1 id=\"wil\" class=\"".$class."\" name=\"".$name."\">"."\n";
	echo"<option value=\"".$value."\"  selected=\"selected\">".$selected."</option>"."\n";
	mysql_query("SET NAMES 'UTF8' ");
	$result = mysql_query("SELECT * FROM pays  order by nom_fr_fr" );
	while($data =  mysql_fetch_array($result))
	{
	echo '<option value="'.$data[2].'">'.$data[5].'</option>';
	}
	echo '</select>'."\n"; 
	}
	...
	function REGION_F($class,$id,$name,$value,$selected) 
	{
	$cnx = mysql_connect($this->db_host,$this->db_user,$this->db_pass)or die ('I cannot connect to the database because: ' . mysql_error());
	$db  = mysql_select_db($this->db_name,$cnx) ;
	...
	echo"<option value=\"".$value."\" selected=\"selected\">".$selected."</option>"."\n";
	mysql_query("SET NAMES 'UTF8' ");
	$result = mysql_query("SELECT * FROM region_f  order by region" );
	while($data =  mysql_fetch_array($result))
	{
	echo '<option value="'.$data[0].'">'.$data[1].'</option>';
	}
	...
	function TS_HJSP($class,$id,$name,$value,$selected) 
	{
	$cnx = mysql_connect($this->db_host,$this->db_user,$this->db_pass)or die ('I cannot connect to the database because: ' . mysql_error());
	$db  = mysql_select_db($this->db_name,$cnx) ;
	echo "<select class=\"".$class."\"  id=\"".$id."\"  name=\"".$name."\">"."\n";
	echo"<option value=\"".$value."\" selected=\"selected\">".$selected."</option>"."\n";
	mysql_query("SET NAMES 'UTF8' ");
	$result = mysql_query("SELECT * FROM ts_hjsp  order by ts_hjsp" );
	while($data =  mysql_fetch_array($result))
	{
	echo '<option value="'.$data[0].'">'.$data[1].'</option>';
	}
	...
	function STATIONT1($id,$name,$class,$value,$selected) 
	{
	$cnx = mysql_connect($this->db_host,$this->db_user,$this->db_pass)or die ('I cannot connect to the database because: ' . mysql_error());
	$db  = mysql_select_db($this->db_name,$cnx) ;		 
	echo "<select size=1 id=\"".$id."\" class=\"".$class."\" name=\"".$name."\">"."\n";
	...
	function EQUINx($id,$name,$class,$value,$selected,$sexe) 
	{
	$cnx = mysql_connect($this->db_host,$this->db_user,$this->db_pass)or die ('I cannot connect to the database because: ' . mysql_error());
	$db  = mysql_select_db($this->db_name,$cnx) ;	 
	echo "<select size=1 id=\"".$id."\" class=\"".$class."\" name=\"".$name."\">"."\n";
	...
	while($data =  mysql_fetch_array($result))
	{
	echo '<option value="'.$data[0].'">'.$data[7].'_('.$data[9].')_'.$data[2].'</option>';
	}
	echo '</select>'."\n"; 
	}
	...
	function EQUINTx($id,$name,$class,$value,$selected) 
	{
	$cnx = mysql_connect($this->db_host,$this->db_user,$this->db_pass)or die ('I cannot connect to the database because: ' . mysql_error());
	$db  = mysql_select_db($this->db_name,$cnx) ;	 
	echo "<select size=1 id=\"".$id."\" class=\"".$class."\" name=\"".$name."\">"."\n";
	...
	function BILANx($id,$name,$class,$value,$selected) 
	{
	$cnx = mysql_connect($this->db_host,$this->db_user,$this->db_pass)or die ('I cannot connect to the database because: ' . mysql_error());
	$db  = mysql_select_db($this->db_name,$cnx) ;

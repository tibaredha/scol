...
$sql = " select * from cheval where wil=$WILAYAR and  com=$COMMUNER   ";
...
<text class="label" id="country_name1" x="320" y="30">Wilaya De Djelfa</text>  	  
<text class="label" id="country_name1" x="250" y="45">Repartition Des Equins Par Commune</text>  	  
<path  
   d="M 120  
       74 L 149  
       74 L 158  
